...
export const EPILOGUE = [
  'THE 8 PIECES GO BACK TOGETHER IN ZELDA\'S HANDS. THE TRIFORCE OF WISDOM IS WHOLE AGAIN, AND IT IS HERS TO KEEP.',

  'SHE BROKE IT APART IN ONE NIGHT, WITH GANON\'S SOLDIERS ALREADY ON THE STAIRS. IT COST HER EVERY YEAR SINCE.',

  'THE TRIFORCE OF POWER IS YOURS NOW. YOU TOOK IT BACK FROM GANON, WHO SHOULD NEVER HAVE HELD IT AT ALL.',

  'IMPA IS ALIVE. THE OLD MEN COME UP OUT OF THEIR CAVES, BLINK AT THE DAYLIGHT, AND ARGUE ABOUT WHICH OF THEM HELPED YOU MOST.',

  'THE 8 DUNGEONS STAY WHERE THEY ARE. HYRULE DOES NOT FILL THEM IN. SOME DOORS ARE BETTER LEFT SHUT.',

  'YOU WENT UNDERGROUND WITH A WOODEN SWORD AND CAME BACK WITH THE WHOLE KINGDOM.',
